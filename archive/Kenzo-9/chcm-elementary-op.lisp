...
(DEFGENERIC CMPS (arg1 arg2 &optional arg3))
...
(DEFGENERIC ADD (arg1 arg2 &optional arg3))
...
(DEFGENERIC SBTR (arg1 arg2 &optional arg3))
   ...
   (the morphism
      ...
      (with-slots ((sorc2 sorc) (trgt2 trgt) (degr2 degr) (strt2 strt)) mrph2
         ...
         (unless (and (eq (grmd sorc1) (grmd sorc2))
                      (eq (grmd trgt1) (grmd trgt2))
                      (= degr1 degr2))
            (error "In 2MRPH-SBTR, ~A and ~A may not be subtracted." mrph1 mrph2))
         (when (eq (first (orgn mrph1)) 'zero-mrph)
