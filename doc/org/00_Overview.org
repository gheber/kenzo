#+BEGIN_SRC lisp :session 00 :exports none :results silent
(ql:quickload "kenzo")
(use-package :cat)
#+END_SRC
...
#+BEGIN_SRC lisp :session 00 :exports none
(defvar m23)
#+END_SRC

#+BEGIN_SRC lisp :session 00 :exports both
(setf m23 (moore 2 3))
#+END_SRC
...
#+BEGIN_SRC lisp :session 00 :results output
(homology m23 0 5)
#+END_SRC
...
#+BEGIN_SRC lisp :session 00 :exports both :results verbatim
(basis m23xm23 6)
#+END_SRC
...
#+BEGIN_SRC lisp :session 00 :exports both :results output
