...
{\leftskip=15mm
Construct\index{Moore space} a simplicial set, a model for  ${\rm Moore}(\mathbb{Z}/{p\mathbb{Z}},n)$.
...
{\leftskip=15mm
If $k=1$ or omitted, build a simplicial set model\index{projective spaces} of $K(\mathbb{Z}_2,1)= P^\infty {\R}$.
