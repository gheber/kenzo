...
with an example of a chain complex. The {\em simplicial complexes}\index{simplicial complexes} are good candidates
...
After creation of a chain complex instance, the function {\tt build-chcm} pushes this
...
taking into account the strategy\index{morphisms!strategy for applying} ({\tt strt}).
...
To apply\index{morphisms!applying} an already constructed morphism to a generator,
...
The following functions\index{morphisms!functions for defining} are useful for working on morphisms, particularly to define
