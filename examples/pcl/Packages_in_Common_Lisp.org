...
* First toy examples.
  ...
  **Note:** Before setting the saw to the branch on which we are sitting,
  ...
  interaction between Emacs and SLIME will stop functioning.
  ...
  **Note:** The following is necessary to keep interaction between Emacs and
  SLIME going. Otherwise, this would be another conflicting symbol.
