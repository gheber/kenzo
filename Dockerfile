...
RUN wget -nv http://downloads.sourceforge.net/project/sbcl/sbcl/1.3.5/sbcl-1.3.5-x86-64-linux-binary.tar.bz2 \
 && tar -jxvf sbcl-1.3.5-x86-64-linux-binary.tar.bz2 \
 && cd sbcl-1.3.5-x86-64-linux \
 && sh install.sh
